                  ...
                  <div class="flex items-center justify-center w-1/4">
                    {selectedItemImage ? (
                      ...
                      <div className="w-1/4 ">
                        <label
                          for="dropzone-file"
                          class="flex flex-col items-center justify-center w-52 h-52 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                        >
